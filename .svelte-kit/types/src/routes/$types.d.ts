...
type LayoutRouteId = RouteId | "/" | "/(subpages)/auth" | "/(subpages)/mint" | "/creator/[address]" | "/job/[address]" | "/job/[address]/[slot]" | "/jobs" | "/listings" | "/messages" | "/new_job" | "/profile" | "/skills" | null
