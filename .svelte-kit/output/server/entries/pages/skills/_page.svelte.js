import { c as create_ssr_component, f as escape, g as null_to_empty, d as add_attribute, e as each, b as subscribe, v as validate_component } from "../../../chunks/index.js";
import { S as Svrollbar } from "../../../chunks/Svrollbar.js";
/* empty css                                                      */import { S as Skeleton } from "../../../chunks/Skeleton.js";
import { f as nodeProvider } from "../../../chunks/Network.js";
...
let placeholder_image$1 = "assets/xcopy.gif";
...
<section class="${escape(null_to_empty(chosen ? "chosen" : ""), true) + " svelte-wg54sw"}"><div class="${"contents svelte-wg54sw"}"><div class="${"thumbnail svelte-wg54sw"}"><img${add_attribute("src", image_urls[0] ?? placeholder_image$1, 0)} alt="${"gallery"}" class="${"preview-image svelte-wg54sw"}"${add_attribute("this", image_component, 0)}></div>
    ...
    return `<div class="${"tag svelte-wg54sw"}"><p class="${"link svelte-wg54sw"}">${escape(tag.value)} <span class="${"light-40 svelte-wg54sw"}">${escape(tag.key)}</span></p></div>
		...
		<div class="${"actions svelte-wg54sw"}"><div class="${"action svelte-wg54sw"}"><a href="${"/messages"}"><img src="${"icons/message.svg"}" alt="${"message"}"></a></div>
			<div class="${"action svelte-wg54sw"}"><img src="${"icons/heart.svg"}" alt="${"heart"}"></div></div></div></section>
<div style="${"height: 12px"}"></div>`;
});
const SkillPage_svelte_svelte_type_style_lang = "";
const css$1 = {
  code: "main.svelte-1095jo6.svelte-1095jo6{width:520px;display:flex;flex-direction:column}.profile-bar.svelte-1095jo6.svelte-1095jo6{display:flex;flex-direction:row;justify-content:space-between;align-items:center;border-width:1px 1px 0px 1px;border-style:solid;border-color:var(--color-light-10);cursor:pointer}.left-section.svelte-1095jo6.svelte-1095jo6{display:flex;flex-direction:row;align-items:center}.pfp.svelte-1095jo6.svelte-1095jo6{width:40px;height:40px}.gallery.svelte-1095jo6.svelte-1095jo6{width:518px;border-width:1px 1px 1px 1px;border-style:solid;border-color:var(--color-light-10);display:flex;flex-direction:column}.gallery-images.svelte-1095jo6.svelte-1095jo6{width:100%;height:388px;border-width:0px 0px 1px 0px;border-style:solid;border-color:var(--color-light-10)}.gallery-buttons.svelte-1095jo6.svelte-1095jo6{display:flex;flex-direction:row;justify-content:space-between;align-items:center;cursor:pointer}.left-gallery-button.svelte-1095jo6.svelte-1095jo6{border-width:0px 1px 0px 0px;border-style:solid;border-color:var(--color-light-10);padding:8px 12px}.right-gallery-button.svelte-1095jo6.svelte-1095jo6{border-width:0px 0px 0px 1px;border-style:solid;border-color:var(--color-light-10);padding:8px 12px}.right-gallery-button.svelte-1095jo6.svelte-1095jo6:hover{background-color:var(--color-primary)}.right-gallery-button.svelte-1095jo6:hover p.svelte-1095jo6{color:var(--color-dark)}.description.svelte-1095jo6.svelte-1095jo6{border-width:1px 1px 1px 1px;border-style:solid;border-color:var(--color-light-10);padding:12px}.link-container.svelte-1095jo6.svelte-1095jo6{display:flex;flex-direction:row;align-items:center;border-width:1px;border-style:solid;border-color:var(--color-light-10)}.placeholder.svelte-1095jo6.svelte-1095jo6{padding:8px 12px;border-width:0px 1px 0px 0px;border-style:solid;border-color:var(--color-light-10)}.wrapper.svelte-1095jo6.svelte-1095jo6{position:relative;-ms-overflow-style:none;scrollbar-width:none;overflow-y:scroll;--svrollbar-track-width:1px;--svrollbar-track-opacity:1;--svrollbar-thumb-width:10px;--svrollbar-thumb-background:#d9ab55;--svrollbar-thumb-opacity:1}.viewport.svelte-1095jo6.svelte-1095jo6{position:relative;overflow:scroll;box-sizing:border-box;-ms-overflow-style:none;scrollbar-width:none}.viewport.svelte-1095jo6.svelte-1095jo6::-webkit-scrollbar{display:none}",
  map: null
};
...
const SkillPage = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<main class="${"svelte-1095jo6"}"><div class="${"profile-bar svelte-1095jo6"}"><div class="${"left-section svelte-1095jo6"}"><img class="${"pfp svelte-1095jo6"}"${add_attribute(
    "src",
	...
	<div class="${"wrapper svelte-1095jo6"}"><div class="${"viewport svelte-1095jo6"}"${add_attribute("style", `height:${feedHeight.toString() + "px"}`, 0)}${add_attribute("this", viewport, 0)}><div class="${"contents"}"${add_attribute("this", contents, 0)}><div class="${"gallery svelte-1095jo6"}"><img class="${"gallery-images svelte-1095jo6"}"${add_attribute("src", trimmed_images[chosen_image], 0)} alt="${"Gallery"}">
					<div class="${"gallery-buttons svelte-1095jo6"}"><div class="${"left-gallery-button svelte-1095jo6"}"><p class="${"light-40"}">PREVIOUS</p></div>
						<p>${escape(chosen_image + 1)}/${escape(trimmed_images.length)}</p>
						<div class="${"right-gallery-button svelte-1095jo6"}"><p class="${"light-40 svelte-1095jo6"}">NEXT</p></div></div></div>
				<div style="${"height:12px;"}"></div>
				<div class="${"description svelte-1095jo6"}"><div class="${"body-text light-80"}">${escape(skill.description)}</div></div>
				<div style="${"height:12px;"}"></div>
				<div class="${"links"}">${each(skill.links, (link) => {
    return `<div class="${"link-container svelte-1095jo6"}"><p class="${"placeholder light-40 svelte-1095jo6"}">link</p>
							<div style="${"width:8px;"}"></div>
